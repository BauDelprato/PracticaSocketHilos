...
public class ClienteUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            out.writeUTF("SUBASTAR");
            out.writeUTF(jTextField1.getText());
            jTextField1.setText("");
        } catch (IOException e) {
            area.append("Error al subastar\n");
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            out.writeUTF("OFERTAR " + jTextField3.getText());
            jTextField3.setText("");
        } catch (IOException e) {
            area.append("Error al ofertar\n");
        }
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            out.writeUTF("MENSAJE " + jTextField2.getText());
            jTextField2.setText("");
        } catch (IOException e) {
            area.append("Error al enviar mensaje\n");
        }
